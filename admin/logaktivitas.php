...
// Ambil data log aktivitas semua user
$sql = "SELECT l.id, u.nama_lengkap, l.waktu_masuk, l.waktu_keluar, l.status 
        FROM log_aktivitas AS l 
...
<head>
    ...
    <link rel="stylesheet" href="../css/admin/logaktivitas.css">
</head>
    ...
    <div class="container">
        <aside class="sidebar">
            ...
            <nav>
                ...
                <a href="logaktivitas.php" class="active"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000" alttext="Logo Laporan Akhir">
        ...
        <main class="main-content">
            ...
            <section class="dashboard">
                <hr class="separator">
                <h2>Aktivitas Pengguna Saat Ini</h2>
                ...
                <tbody>
                    <?php if ($result_log->num_rows > 0): ?>
                        ...
                        <?php endwhile; ?>
                    <?php else: ?>
                        <tr><td colspan="4">Belum ada data aktivitas.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
            </section>
