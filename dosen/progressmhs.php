    ...
    <div class="container">
        <aside class="sidebar">
            ...
            <nav>
                ...
                <a href="progressmhs.php" class="active"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000" alttext="Logo Kegiatan PKL">
                    ...
                    <tbody>
                        <?php while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="detail_progress.php?user_id=<?= $row['user_id'] ?>">Lihat Progress</a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
