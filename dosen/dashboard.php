...
$query = mysqli_query($conn, "SELECT COUNT(*) AS jumlah_bimbingan FROM pkl_data WHERE pembimbing = $id_dosen");
$data = mysqli_fetch_assoc($query);
$jumlahBimbingan = $data['jumlah_bimbingan'];

$query = $conn->query("SELECT * FROM users WHERE user_id = $id_dosen");
$user = $query->fetch_assoc();
$query = $conn->query("SELECT * FROM pkl_data WHERE user_id = $id_dosen");
...
<head>
    ...
    <link rel="stylesheet" href="../css/dosen/dashboard.css">
</head>
    ...
    <div class="container">
        ...
        <main class="main-content">
            ...
            <section class="dashboard">
                ...
                <body class="halaman-dosen-dashboard">
                    <div class="dashboard-container">
                        <!-- Konten Utama -->
                        <main class="main-content">
                            <section class="welcome">
                                <h2>Selamat datang,<br><?php echo $user['nama_lengkap'] ?></h2>
                                <div class="stat-box">
                                    <p>Jumlah Mahasiswa<br><strong>Bimbingan</strong><br><span class="jumlah"><?= $jumlahBimbingan; ?></span></p>
                                </div>
                                <div class="menu-boxes">
                                    <div class="menu-item"><a href="daftarmhs.php">📋<br>Daftar Mahasiswa<br>Bimbingan</a></div>
                                    <div class="menu-item"><a href="progressmhs.php">📈<br>Progres Mahasiswa</a></div>
                                    <div class="menu-item"><a href="laporanakhirmhs.php">📑<br>Laporan Akhir Mahasiswa</a></div>
                                </div>
                            </section>
                        </main>
                    </div>
