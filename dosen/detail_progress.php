...
// Ambil data kegiatan dari mahasiswa bimbingan
$result = $conn->query("
    SELECT k.minggu, k.tanggal, k.nama_kegiatan, k.file, k.status
    FROM kegiatan k
    JOIN pkl_data p ON k.id_user = p.user_id
    WHERE p.pembimbing = $id_dosen
    ORDER BY k.minggu ASC
");
...
<head>
    ...
    <link rel="stylesheet" href="../css/dosen/progressmhs.css">
</head>
    ...
    <div class="container">
        ...
        <main class="main-content">
            ...
            <section class="dashboard">
                <hr class="separator">
                <h3>Laporan Progress Mahasiswa</h3>
                    ...
                    <tbody>
                        ...
                        while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="../mhs/uploads/<?= htmlspecialchars($row['file']) ?>" target="_blank">Lihat</a>
                                </td>
