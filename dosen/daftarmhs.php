...
$id_dosen = $_SESSION['user_id']; // ID dosen yang sedang login

$data_mhs = mysqli_query($conn, "
    SELECT nama_lengkap, nim, nama_perusahaan, tanggal_mulai, tanggal_selesai
    FROM pkl_data
    WHERE pembimbing = $id_dosen
");
...
<head>
    ...
    <link rel="stylesheet" href="../css/dosen/daftarmhs.css">
</head>
    ...
    <div class="container">
        <aside class="sidebar">
            ...
            <nav>
                ...
                <a href="daftarmhs.php" class="active"><svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#000000" alttext="Logo Isi Data">
        ...
        <main class="main-content">
            ...
            <section class="dashboard">
                ...
                <table class="table table-bordered" border="1" cellpadding="10" cellspacing="0" style="width:100%; border-collapse:collapse;">
                    <thead>
                        <tr>
                            <th>No</th>
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($data_mhs)) :
                            ...
                            $bulan = ($interval->y * 12) + $interval->m; // tahun ke bulan + bulan
                        ?>
                            <tr>
                                <td><?= $no++; ?></td>
